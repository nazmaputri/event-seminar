...
@section('title', 'Event | Seminar')

@section('content')
<div class="px-0 md:[x-3]">
    <div class="flex justify-between text-sm  md:text-base mt-8 mx-5 md:mx-12">
        <h1 class="font-semibold text-blue-700 ">Event Yang Akan Berlangsung</h1>
    </div>
    ...
    <div class="mx-auto p-1 md:p-4 mt-3 bg-white rounded-lg shadow-lg">
        ...
        @foreach($events as $event)
                 ...
                 <div class="group relative shadow-sm rounded-lg bg-white p-2 md:p-3 border border-slate-300 shadow-md">
                        ...
                        <div class="flex justify-center items-center">
                            <div class="grid mt-1">
                                <div class="flex items-center space-x-1 text-xs font-semibold">
                                    ...
                                    <p class="text-white bg-teal-400 py-0.5 text-center rounded-xl px-3">
                                        {{ $event->jenis_event }}
                                    </p>
                                </div>
                            </div>
                        ...
                        <a href="{{ route('login') }}">
                            <button class="bg-blue-400 text-white w-full rounded-full py-1 text-sm hover:bg-blue-600">Daftar</button>
                        </a>                        
                </div>
                <!-- End Card Event -->
                @endforeach
...
<div class="mr-12 mt-3">
    ...
    <ul class="inline-flex -space-x-px text-sm md:justify-end justify-center items-center w-full">  
        {{ $events->links() }}
    </ul>
</nav>
</div>
